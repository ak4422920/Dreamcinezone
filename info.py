...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002208313355'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002471953287'))  # Notification of those who verify will be sent to your channel
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/FmN.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@The_SonGoku [msg here]')
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://tg:tg@cluster0.fekvk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002453651327'))  # Log channel id (make sure bot is admin)
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/akhowtoopenlinks/45')  # Tutorial video link for opening shortlink website
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Cineoriginals')
